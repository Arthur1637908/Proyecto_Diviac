package pe.com.gob.diviac.business.police.adapter.input.web.situation.model.update.response;
...
@Setter
@Getter
@Schema(name = "UpdateSituationResponseBusiness")
public class UpdateSituationRestResponse extends SituationRestResponse {

    @Builder
    public UpdateSituationRestResponse(Long id, PoliceRestResponse police, ParameterRestResponse situationType,
