package pe.com.gob.diviac.business.police.adapter.input.web.generalinformation.model.update.response;
...
@Setter
@Getter
@Schema(name = "UpdateGeneralInformationResponseBusiness")
public class UpdateGeneralInformationRestResponse extends GeneralInformationRestResponse {

    @Builder
    public UpdateGeneralInformationRestResponse(UUID id, String cip, DivisionRestResponse division,
